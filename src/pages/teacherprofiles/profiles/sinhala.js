...
import Teacher1 from '../../../assets/SINHALA.webp';
import RegistrationModal from '../../../components/RegistrationModal';

const ALL_CLASSES = [
  { id: 1, title: "Sinhala", batch: "2026 A/L Batch", grade: "2026 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Monday", "Thursday"], location: "Sinhaya · Maharagama", pattern: "a" },
  { id: 2, title: "Sinhala", batch: "2027 A/L Batch", grade: "2027 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Monday", "Thursday"], location: "Sinhaya · Maharagama", pattern: "b" },
  { id: 3, title: "Sinhala", batch: "2028 A/L Batch", grade: "2028 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Monday", "Thursday"], location: "Sinhaya · Maharagama", pattern: "c" },
];

const GRADES = ["All Grades","2026 A/L","2027 A/L","2028 A/L"];
const DAYS   = ["All Days","Monday","Thursday","Friday","Saturday"];
const TEACHER_INFO = { id: 'sinhala', name: 'Pathum Sandanuwan', subject: 'Sinhala', stream: 'Arts' };
...
const css = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .tp-vid-thumb img{width:100%;height:100%;object-fit:cover;display:block;transition:transform .7s cubic-bezier(.22,1,.36,1),filter .45s;filter:brightness(.92)}
    ...
    <div className="tp">
      ...
      <div className="tp-hero">
        <nav className="tp-breadcrumb">
          ...
          <span className="tp-breadcrumb-cur">Pathum Sandanuwan</span>
        </nav>

        <div className="tp-hero-inner">
          <div className="tp-hero-top">
            <div className="tp-avatar-wrap">
              <img src={Teacher1} alt="Pathum" className="tp-avatar" />
            </div>

            <div className="tp-identity">
              <h1 className="tp-name">Pathum Sandanuwan</h1>
          ...
          <div className="tp-about">
            ...
            <p className="tp-about-text">
              කැළණිය විශ්ව විද්‍යාලයේ සම්මාන උපාධිධාරියෙකි. A/L සිංහල විෂය සඳහා පළපුරුදු ගුරුවරයෙකි.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="tp-tabs">
        <div className="tp-tabs-inner">
          ...
          <button className={`tp-tab${tab === 'videos' ? ' active' : ''}`} onClick={() => setTab('videos')}>
            Videos {VIDEOS.length > 0 && <span className="tp-tab-badge">{VIDEOS.length}</span>}
          </button>
        </div>
      </div>
      ...
      <div className="tp-body">
        ...
        {tab === 'videos' && (
          VIDEOS.length > 0 ? (
            ...
            <div className="tp-videos-empty">
              <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="#eee" strokeWidth="1.5"><rect x="2" y="2" width="20" height="20" rx="4"/><polygon points="10 8 16 12 10 16 10 8" fill="#eee" stroke="none"/></svg>
