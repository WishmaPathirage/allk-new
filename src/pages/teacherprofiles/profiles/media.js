...
import Teacher1 from '../../../assets/MEDIA.webp';
import RegistrationModal from '../../../components/RegistrationModal';

const ALL_CLASSES = [
  { id: 1, title: "Communication & Media Studies", batch: "2026 A/L Batch", grade: "2026 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "a" },
  { id: 2, title: "Communication & Media Studies", batch: "2027 A/L Batch", grade: "2027 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "b" },
  { id: 3, title: "Communication & Media Studies", batch: "2028 A/L Batch", grade: "2028 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "c" },

];

const GRADES = ["All Grades","2026 A/L","2027 A/L","2028 A/L",];
const DAYS   = ["All Days","Tuesday","Wednesday","Friday","Saturday"];
const TEACHER_INFO = { id: 'media', name: 'Praveen Kumarage', subject: 'Media', stream: 'Arts' };
    ...
    <div className="tp">
      ...
      <div className="tp-hero">
        <nav className="tp-breadcrumb">
          ...
          <span className="tp-breadcrumb-cur">Pradeep Kumarage</span>
        </nav>
        ...
        <div className="tp-hero-inner">
          ...
          <div className="tp-hero-top">
            <div className="tp-avatar-wrap">
              <img src={Teacher1} alt="Pradeep" className="tp-avatar" />
            </div>

            <div className="tp-identity">
              <h1 className="tp-name">Pradeep Kumarage</h1>
              ...
              <span className="tp-degree">
                ...
                B.A (hon's) Public Relations and Media Management· University of Kelaniya
              </span>
            </div>
          </div> 
          ...
          <div className="tp-about">
            ...
            <p className="tp-about-text">
                කැලණිය විශ්වවිද්‍යාලයේ මහජන සම්බන්ධතා හා මාධ්‍ය කළමනාකරණය පිළිබඳ ගෞරව උපාධිධාරී,
කොළඹ, ගම්පහ, මාතලේ දිස්ත්‍රික්කවල ඉහළ ම ප්‍රතිඵල සමඟින්,
භෞතික පන්ති කලාවේ ප්‍රමුඛයා දැන් Online අවකාශයෙන් ඔබේ අලින්දයට.
            </p>
