...
import Teacher1 from '../../../assets/POLITICAL.webp';
import RegistrationModal from '../../../components/RegistrationModal';

const ALL_CLASSES = [
  { id: 1, title: "Political Science", batch: "2026 A/L Batch", grade: "2026 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "a" },
  { id: 2, title: "Political Science", batch: "2027 A/L Batch", grade: "2027 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "b" },
  { id: 3, title: "Political Science", batch: "2028 A/L Batch", grade: "2028 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "c" },

];

const GRADES = ["All Grades","2026 A/L","2027 A/L","2028 A/L",];
const DAYS   = ["All Days","Tuesday","Wednesday","Friday","Saturday"];
const TEACHER_INFO = { id: 'political', name: 'Amila Nishan Pitiduwa', subject: 'Political Science', stream: 'Arts' };
    ...
    <div className="tp">
      ...
      <div className="tp-hero">
        <nav className="tp-breadcrumb">
          ...
          <span className="tp-breadcrumb-cur">Amila Nishan Pitiduwa</span>
        </nav>
        ...
        <div className="tp-hero-inner">
          ...
          <div className="tp-hero-top">
            <div className="tp-avatar-wrap">
              <img src={Teacher1} alt="Amila" className="tp-avatar" />
            </div>

            <div className="tp-identity">
              <h1 className="tp-name">Amila Nishan Pitiduwa</h1>
              ...
              <span className="tp-degree">
                ...
                Msc of Arts · Political Science · University of Kelaniya
              </span>
            </div>
          </div>
          ...
          <div className="tp-about">
            ...
            <p className="tp-about-text">
              ඉහළ තලයේ රැකියා ක්ෂේත්‍ර රැසකට මංපෙත් විවර කරන , නීතිය සමඟ ඍජු සම්බන්ධයක් ඇති , Z අගය ඉහළම විෂයට පණ පොවන , දිස්ත්‍රික් ප්‍රථමයා හා දෙවැනියා ඇතුලු ලංකාවේ හොඳම ප්‍රතිඵල වාර්තා කළ ගුරුවරයා ...
            </p>
          </div>
