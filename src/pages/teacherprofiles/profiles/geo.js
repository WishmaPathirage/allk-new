...
import Teacher1 from '../../../assets/GEOGRAPHY.webp';
import RegistrationModal from '../../../components/RegistrationModal';

const ALL_CLASSES = [
  { id: 1, title: "Geography", batch: "2026 A/L Batch", grade: "2026 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "a" },
  { id: 2, title: "Geography", batch: "2027 A/L Batch", grade: "2027 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "b" },
  { id: 3, title: "Geography", batch: "2028 A/L Batch", grade: "2028 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "c" },

];

const GRADES = ["All Grades","2026 A/L","2027 A/L","2028 A/L",];
const DAYS   = ["All Days","Tuesday","Wednesday","Friday","Saturday"];
const TEACHER_INFO = { id: 'geo', name: 'Sameera Ekanayake', subject: 'Geography', stream: 'Arts' };

const VIDEOS = [
  { id: 'D5ycni4pLTk', url: 'https://www.youtube.com/live/D5ycni4pLTk?si=xGGZ692NBIDoNexU', title: 'Free Geography Class 01', duration: '1:18:25' },
  { id: 'oN48TBGwVqw', url: 'https://www.youtube.com/live/oN48TBGwVqw?si=MV_fumHM7mGxJB1q', title: 'Free Geography Class 02', duration: '1:25:55' },
  { id: 'ruLdvxkcuas', url: 'https://youtu.be/ruLdvxkcuas?si=47Ry7ly1LBbhJQmx', title: 'Free Geography Class 03', duration: '59:40' },
];
    ...
    <div className="tp">
      ...
      <div className="tp-hero">
        <nav className="tp-breadcrumb">
          ...
          <span className="tp-breadcrumb-cur">Sameera Ekanayake</span>
        </nav>
        ...
        <div className="tp-hero-inner">
          ...
          <div className="tp-hero-top">
            <div className="tp-avatar-wrap">
              <img src={Teacher1} alt="Sameera" className="tp-avatar" />
            </div>

            <div className="tp-identity">
              <h1 className="tp-name">Sameera Ekanayake </h1>
              ...
              <span className="tp-degree">
                ...
                Bachelor of Arts , Faculty of Social Sciences · University of Kelaniya
              </span>
            </div>
          </div>
          ...
          <div className="tp-about">
            ...
            <p className="tp-about-text">
              වසර 06 ක් පුරාවට නුගේගොඩ, ගම්පහ සහ මෑතක සිට මහනුවර යන ප්‍රධාන නගර ත්‍රිත්වයේම Geography රහට බෙදන ඔහු මහනුවර විද්‍යාර්ථ විද්‍යාලයෙන් උසස් පෙළ හදාරා කැලණිය විශ්ව විද්‍යාලයේ සමාජීය විද්‍යා පීඨයට ප්‍රවිෂ්ඨ වී භූගෝල විද්‍යාව ඇතුළුව සාමාන්‍යවේදී උපාධිය පන්ති සාමාර්ථයක් සහිතව ලබාගෙන ඇත.
            </p>
          </div>
