...
import Teacher1 from '../../../assets/SFT.webp';
import RegistrationModal from '../../../components/RegistrationModal';

const ALL_CLASSES = [
  { id: 1, title: "Science for Technology", batch: "2026 A/L Batch", grade: "2026 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "a" },
  { id: 2, title: "Science for Technology", batch: "2027 A/L Batch", grade: "2027 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "b" },
  { id: 3, title: "Science for Technology", batch: "2028 A/L Batch", grade: "2028 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "c" },

];

const GRADES = ["All Grades","2026 A/L","2027 A/L","2028 A/L",];
const DAYS   = ["All Days","Tuesday","Wednesday","Friday","Saturday"];
const TEACHER_INFO = { id: 'sft', name: 'Shanaka Ranathunga', subject: 'Science for Technology', stream: 'Technology' };

const VIDEOS = [
  { id: 'Vj17vX6w1ag', url: 'https://youtu.be/Vj17vX6w1ag?si=5-K3wone8F1CzMOC', title: 'Free SFT Class 01', duration: '1:15:00' },
  { id: 'uXUFgTeX0Ig', url: 'https://www.youtube.com/live/uXUFgTeX0Ig?si=etmc17PIVCo4OHOm', title: 'Free SFT Class 02', duration: '1:30:20' },
  { id: 'BDaP2_YC_cs', url: 'https://youtu.be/BDaP2_YC_cs?si=Z227mI52bO5X3OX2', title: 'Free SFT Class 03', duration: '1:08:45' },
];
    ...
    <div className="tp">
      ...
      <div className="tp-hero">
        <nav className="tp-breadcrumb">
          ...
          <span className="tp-breadcrumb-cur">Shanaka Ranathunga</span>
        </nav>
        ...
        <div className="tp-hero-inner">
          ...
          <div className="tp-hero-top">
            <div className="tp-avatar-wrap">
              <img src={Teacher1} alt="Shanaka" className="tp-avatar" />
            </div>

            <div className="tp-identity">
              <h1 className="tp-name">Shanaka Ranathunga</h1>
              ...
              <span className="tp-degree">
                ...
                Bachelor of Science · Chemistry · University of Kelaniya
              </span>
            </div>
          </div>
          ...
          <div className="tp-about">
            ...
            <p className="tp-about-text">
              ලංකාවේ මෙතෙක් ඉතිහාසයේ එක් වර්ෂයකදී එක් පන්තියකින් බිහිකළ වැඩිම ප්‍රතිඵල සමඟින් කුරුණෑගල, කෑගල්ල හා නුවරඑළිය යන නගරවල සිද්ධාන්ත පන්ති (Theory) ආරම්භ කළ 2021 වර්ෂයේ සිට 2021, 2022, 2023, 2024 යන වර්ෂවල අඛණ්ඩව එම දිස්ත්‍රික්කවල වැඩිම විශ්වවිද්‍යාල ප්‍රවේශ ප්‍රතිශතය බිහිකළ ගුරුවරයායි.
            </p>
          </div>
