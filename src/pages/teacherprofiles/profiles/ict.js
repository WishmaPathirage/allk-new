...
import Teacher1 from '../../../assets/ICT.webp';
import RegistrationModal from '../../../components/RegistrationModal';

const ALL_CLASSES = [
  { id: 1, title: "Information and Communication Technology", batch: "2026 A/L Batch", grade: "2026 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "a" },
  { id: 2, title: "Information and Communication Technology", batch: "2027 A/L Batch", grade: "2027 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "b" },
  { id: 3, title: "Information and Communication Technology", batch: "2028 A/L Batch", grade: "2028 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "c" },

];

const GRADES = ["All Grades","2026 A/L","2027 A/L","2028 A/L",];
const DAYS   = ["All Days","Tuesday","Wednesday","Friday","Saturday"];
const TEACHER_INFO = { id: 'ict', name: 'Ranishan Dissanayake', subject: 'ICT', stream: 'Technology' };

const VIDEOS = [
  { id: 'QZPmSHSA3F8', url: 'https://youtu.be/QZPmSHSA3F8?si=cLDC37U3LZNmd1ir', title: 'Free ICT Class 01', duration: '1:20:15' },
  { id: 'q2M6D-spkdY', url: 'https://youtu.be/q2M6D-spkdY?si=fgFSUKg5csz6IohT', title: 'Free ICT Class 02', duration: '1:28:30' },
  { id: 'iYhCz3Bf5ls', url: 'https://youtu.be/iYhCz3Bf5ls?si=QvZgWquAvisPlGmj', title: 'Free ICT Class 03', duration: '1:10:55' },
];
    ...
    <div className="tp">
      ...
      <div className="tp-hero">
        <nav className="tp-breadcrumb">
          ...
          <span className="tp-breadcrumb-cur">Ranishan Dissanayake</span>
        </nav>
        ...
        <div className="tp-hero-inner">
          ...
          <div className="tp-hero-top">
            <div className="tp-avatar-wrap">
              <img src={Teacher1} alt="Ranishan" className="tp-avatar" />
            </div>

            <div className="tp-identity">
              <h1 className="tp-name">Ranishan Dissanayake</h1>
          ...
          <div className="tp-about">
            ...
            <p className="tp-about-text">
              වසර 10 කට ආසන්න කාලයක් ශ්‍රී ලාංකීය දූ පුතුන්ට තොරතුරු හා සංනිවේදන තාක්ශණ විශය ඉගැන්වීමේ ප්‍රවීනයෙකු වන රනිශාන් දිසානායක ගුරුතුමා රත්නපුර කෑගල්ල ගම්පහ ආදී නගර වල සහ SLT peo tv තුලින්ද දහස් ගනනක් දූ දරුවන්ට අධ්‍යාපනය ලබාදෙන ගුරුවරයෙකි. වසර ගනනාවක මෘදුකාංග නිර්මාණ ක්ශේත්‍රයේ පලපුරුද්ද සහිතව එම සුදුසුකම් වලට අමතරව තවත් ගනනාවක් අතිරේක CCNA, DICT ආදී සුදුසුකම් ගනනාවක් සහිතව ඒ තුලින්ම ප්‍රායෝගිකවම සිසුවාට විශය ඉගැන්වීම සිසුන්ගේ ඉහල සාමාර්ථ වලට ප්‍රදාන හේතුවයි.
ආසියානු හැකතන් තරගාවලි අතරින් ප්‍රථමස්ථානයන් සහිත මොහු සිසුන්ද එම මාර්ගවලට යොමු කරන්නෙකි.
ඔහු නමින් රනිශාන් දිසානායක වුවද විශය සරලව වටහා දීම නිසාම " ICT කියන්නෙ යකෙක් කළු නැති ළා දම්පාට " යන වදන සමග ඔහුගේ නම සිසුන් අතර ජනප්‍රියත්වයට පත්ව ඇත.</p>
          </div>
