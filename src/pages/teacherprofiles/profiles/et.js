...
const ALL_CLASSES = [
  { id: 1, title: "Engineering Technology", batch: "2026 A/L Batch", grade: "2026 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "a" },
  { id: 2, title: "Engineering Technology", batch: "2027 A/L Batch", grade: "2027 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "b" },
  { id: 3, title: "Engineering Technology", batch: "2028 A/L Batch", grade: "2028 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "c" },

];

const GRADES = ["All Grades","2026 A/L","2027 A/L","2028 A/L",];
const DAYS   = ["All Days","Tuesday","Wednesday","Friday","Saturday"];
const TEACHER_INFO = { id: 'et', name: 'Sandeepa Kathriarachchi', subject: 'Engineering Technology', stream: 'Technology' };

const VIDEOS = [
  { id: 'mWT54tgn43M', url: 'https://www.youtube.com/live/mWT54tgn43M?si=yXjdU5b0QgMn7W-l', title: 'Free ET Class 01', duration: '1:24:38' },
  { id: 'HbPHjLZ9dFY', url: 'https://www.youtube.com/live/HbPHjLZ9dFY?si=soIWOWtsWXbqZKo9', title: 'Free ET Class 02', duration: '1:17:52' },
  { id: 'yGc1-UVQiqY', url: 'https://youtu.be/yGc1-UVQiqY?si=V5ya1bN6Hnm2EXSm', title: 'Free ET Class 03', duration: '1:35:10' },
];
    ...
    <div className="tp">
      ...
      <div className="tp-hero">
        <nav className="tp-breadcrumb">
          ...
          <span className="tp-breadcrumb-cur"> Sandeepa Kathriarachchi</span>
        </nav>
        ...
        <div className="tp-hero-inner">
          ...
          <div className="tp-hero-top">
            <div className="tp-avatar-wrap">
              <img src={Teacher1} alt="Sandeepa" className="tp-avatar" />
            </div>

            <div className="tp-identity">
              <h1 className="tp-name">Sandeepa Kathriarachchi</h1>
              ...
              <span className="tp-degree">
                ...
                Engineering Technology, Faculty of Technology · University of Ruhuna. </span>
            </div>
          </div>
          ...
          <div className="tp-about">
            ...
            <p className="tp-about-text">
              2016 වර්ෂයේදී දිස්ත්‍රික්කයේ පලමු දස දෙනා අනරට නේපන් වෙමින්රුහුණ විශ්වවිලයේ තාක්ෂණික පීඨයේ ඉංජිනේරු නාක්ෂණවේදය ගෞරව උපාධිධාරියකු වන Et ආරච්චිඔබේ ගුරුකුමා,නාක්ෂණවේදී නව නිර්මාණ රැසකට විශ්ව විදලසම්මාන ලාභියෙකි
ඔහු උපාධියට අමනරව NVQ 4 මට්ටමේ නිපුණනා සම්පූර්ණ කර අමනර සුදුසුකම් රැසක් සපුරා ගනිමින් සහකාර ඉංජිස්නේරුවරයෙකු ලෙසද
වෘන්නීය සුදුසුකම් සපුරා ගනිමින් විෂයේ ගැඹුරුම නැන් සරලව උගන්වන නගර කිහිපයක ප්‍රධාන ඉංජිනේරු නාක්ෂණවේදී ගුරුවරයා බවට පන්වීමට ඔහුට හැකියාව ලැබී ඇන.
            </p>
          </div>
