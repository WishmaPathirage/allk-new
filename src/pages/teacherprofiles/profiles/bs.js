...
import Teacher1 from '../../../assets/BS.webp';
import RegistrationModal from '../../../components/RegistrationModal';

const ALL_CLASSES = [
  { id: 1, title: "Business Studies", batch: "2026 A/L Batch", grade: "2026 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "a" },
  { id: 2, title: "Business Studies", batch: "2027 A/L Batch", grade: "2027 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "b" },
  { id: 3, title: "Business Studies", batch: "2028 A/L Batch", grade: "2028 A/L Batch", time: "4:00 PM – 6:00 PM", days: ["Tuesday", "Friday"], location: "Sinhaya · Maharagama", pattern: "c" },

];

const GRADES = ["All Grades","2026 A/L","2027 A/L","2028 A/L",];
const DAYS   = ["All Days","Tuesday","Wednesday","Friday","Saturday"];
const TEACHER_INFO = { id: 'bs', name: 'Kasun Weligama', subject: 'Business Studies', stream: 'Commerce' };

const VIDEOS = [
  { id: 'Mk3fvgTMqyw', url: 'https://youtu.be/Mk3fvgTMqyw?si=g_IZOBtBBlAjKXfg', title: 'Free Business Studies Class 01', duration: '1:22:50' },
  { id: 'GPkFEkRd46U', url: 'https://youtu.be/GPkFEkRd46U?si=fop8UYOb4uv0QUVd', title: 'Free Business Studies Class 02', duration: '1:09:35' },
  { id: 'Tz7uJVP2Nik', url: 'https://youtu.be/Tz7uJVP2Nik?si=hxFe1so5Wblsfe4Y', title: 'Free Business Studies Class 03', duration: '1:31:10' },
];
    ...
    <div className="tp">
      ...
      <div className="tp-hero">
        <nav className="tp-breadcrumb">
          ...
          <span className="tp-breadcrumb-cur">Kasun Weligama</span>
        </nav>
        ...
        <div className="tp-hero-inner">
          ...
          <div className="tp-hero-top">
            <div className="tp-avatar-wrap">
              <img src={Teacher1} alt="Kasun Weligama" className="tp-avatar" />
            </div>

            <div className="tp-identity">
              <h1 className="tp-name">Kasun Weligama</h1>
